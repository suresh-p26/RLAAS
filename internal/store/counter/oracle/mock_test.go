...
func TestMigrate_Success(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("CREATE TABLE rlaas_counters").WillReturnResult(sqlmock.NewResult(0, 0))
	mock.ExpectExec("CREATE TABLE rlaas_timestamps").WillReturnResult(sqlmock.NewResult(0, 0))
	mock.ExpectExec("CREATE INDEX").WillReturnResult(sqlmock.NewResult(0, 0))
	mock.ExpectExec("CREATE TABLE rlaas_leases").WillReturnResult(sqlmock.NewResult(0, 0))
...
func TestMigrate_ORA00955(t *testing.T) {
	s, mock := newMock(t)
	// ORA-00955 = "name is already used by an existing object" — should be ignored.
	mock.ExpectExec("CREATE TABLE rlaas_counters").WillReturnError(errors.New("ORA-00955: name is already used"))
	mock.ExpectExec("CREATE TABLE rlaas_timestamps").WillReturnError(errors.New("already used"))
	mock.ExpectExec("CREATE INDEX").WillReturnResult(sqlmock.NewResult(0, 0))
	mock.ExpectExec("CREATE TABLE rlaas_leases").WillReturnResult(sqlmock.NewResult(0, 0))

	if err := s.Migrate(context.Background()); err != nil {
		t.Fatalf("migrate should ignore ORA-00955: %v", err)
	}
}

func TestMigrate_Error(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("CREATE TABLE rlaas_counters").WillReturnError(errors.New("ORA-01031: insufficient privileges"))
...
func TestIncrement_Success(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("MERGE INTO rlaas_counters").WillReturnResult(sqlmock.NewResult(0, 1))
	mock.ExpectQuery("SELECT value FROM rlaas_counters WHERE key").
		WillReturnRows(sqlmock.NewRows([]string{"value"}).AddRow(int64(5)))

	val, err := s.Increment(context.Background(), "key1", 5, time.Minute)
	if err != nil || val != 5 {
		t.Fatalf("increment: val=%d err=%v", val, err)
	}
}

func TestIncrement_MergeError(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("MERGE INTO rlaas_counters").WillReturnError(errors.New("merge fail"))
...
func TestIncrement_ReadbackError(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("MERGE INTO rlaas_counters").WillReturnResult(sqlmock.NewResult(0, 1))
	mock.ExpectQuery("SELECT value FROM rlaas_counters WHERE key").WillReturnError(errors.New("readback fail"))
...
func TestGet_NoRows(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectQuery("SELECT value FROM rlaas_counters").WillReturnError(sql.ErrNoRows)
...
func TestGet_Error(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectQuery("SELECT value FROM rlaas_counters").WillReturnError(errors.New("query fail"))
...
func TestSet_Error(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("MERGE INTO rlaas_counters").WillReturnError(errors.New("set fail"))
...
func TestCompareAndSwap_Match(t *testing.T) {
	...
	mock.ExpectExec("UPDATE rlaas_counters SET value").WillReturnResult(sqlmock.NewResult(0, 1))
	mock.ExpectCommit()
...
func TestCompareAndSwap_SelectError(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectBegin()
	mock.ExpectQuery("SELECT value FROM rlaas_counters").WillReturnError(errors.New("select fail"))
	mock.ExpectRollback()
...
func TestAddTimestamp_Error(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("INSERT INTO rlaas_timestamps").WillReturnError(errors.New("ts fail"))
...
func TestCountAfter_Success(t *testing.T) {
	...
	cnt, err := s.CountAfter(context.Background(), "key1", time.Now())
	if err != nil || cnt != 7 {
...
func TestTrimBefore_Success(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("DELETE FROM rlaas_timestamps").WillReturnResult(sqlmock.NewResult(0, 3))
...
func TestTrimBefore_Error(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("DELETE FROM rlaas_timestamps").WillReturnError(errors.New("trim fail"))
...
func TestAcquireLease_Success(t *testing.T) {
	...
	mock.ExpectExec("MERGE INTO rlaas_leases").WillReturnResult(sqlmock.NewResult(0, 1))
	mock.ExpectCommit()
...
func TestAcquireLease_AtLimit(t *testing.T) {
	...
	ok, _, err := s.AcquireLease(context.Background(), "k1", 5, time.Minute)
	if err != nil || ok {
		t.Fatalf("acquire at limit: ok=%v err=%v", ok, err)
	}
}
...
func TestAcquireLease_NoRows(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectBegin()
	mock.ExpectQuery("SELECT value FROM rlaas_leases").WillReturnError(sql.ErrNoRows)
	mock.ExpectExec("MERGE INTO rlaas_leases").WillReturnResult(sqlmock.NewResult(0, 1))
	mock.ExpectCommit()
...
func TestAcquireLease_SelectError(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectBegin()
	mock.ExpectQuery("SELECT value FROM rlaas_leases").WillReturnError(errors.New("select fail"))
	mock.ExpectRollback()
...
func TestPurgeExpired_Success(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("DELETE FROM rlaas_counters WHERE expires_at").WillReturnResult(sqlmock.NewResult(0, 2))
	mock.ExpectExec("DELETE FROM rlaas_timestamps WHERE expires_at").WillReturnResult(sqlmock.NewResult(0, 1))
	mock.ExpectExec("DELETE FROM rlaas_leases WHERE expires_at").WillReturnResult(sqlmock.NewResult(0, 0))
...
func TestPurgeExpired_Error(t *testing.T) {
	s, mock := newMock(t)
	mock.ExpectExec("DELETE FROM rlaas_counters WHERE expires_at").WillReturnError(errors.New("purge fail"))
...
func TestIsOracleObjExists(t *testing.T) {
	if isOracleObjExists(nil) {
		t.Fatal("nil should be false")
	}
	if !isOracleObjExists(errors.New("ORA-00955: name is already used")) {
		t.Fatal("ORA-00955 should match")
	}
	if !isOracleObjExists(errors.New("already used")) {
		t.Fatal("'already used' should match")
	}
	if isOracleObjExists(errors.New("ORA-01031: something else")) {
		t.Fatal("other ORA errors should not match")
	}
}
